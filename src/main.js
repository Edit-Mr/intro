...
const scrollAnimation = () => {
  ...
  console.log(process);
  if (process > .6) {
    camera.position.x = keyframes[data + 1].px;
    camera.position.y = keyframes[data + 1].py;
    camera.position.z = keyframes[data + 1].pz;
    camera.rotation.x = keyframes[data + 1].rx;
    camera.rotation.y = keyframes[data + 1].ry;
    camera.rotation.z = keyframes[data + 1].rz;
  } else {
    process *= 1.5;
    camera.position.x =
      keyframes[data].px +
